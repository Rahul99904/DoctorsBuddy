...
public class kalyan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btmumgenjj.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent io=new Intent(kalyan.this,JJ.class);
                startActivity(io);
            }
        });
        ...
        btmumspett.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ig=new Intent(kalyan.this,TCAN.class);
                startActivity(ig);
            }
        });
        ...
        btmumgensi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ig=new Intent(kalyan.this,JJ.class);
                startActivity(ig);
            }
        });
