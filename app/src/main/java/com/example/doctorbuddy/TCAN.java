...
public class TCAN extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tcan);
        ...
        nextjj.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(radioGroupjj.getCheckedRadioButtonId()!=-1) {
                    ...
                    Intent in = new Intent(TCAN.this, JJFORM.class);
                    ...
                    Toast.makeText(TCAN.this,"Please Select Doctor",Toast.LENGTH_LONG).show();
                }
